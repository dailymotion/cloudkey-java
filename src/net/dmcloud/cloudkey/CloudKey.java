...
public class CloudKey extends Api {
    ...
    public CloudKey(String _user_id, String _api_key, String _base_url, String _cdn_url, String httpProxyHost, int httpProxyPort) {
        super(_user_id, _api_key, _base_url, _cdn_url, httpProxyHost, httpProxyPort);
    }
    ...
    public String mediaCreate(File f, DCArray assets_names, DCObject meta) throws Exception {
        ...
        try {
            ...
            if (httpProxyHost != null && !httpProxyHost.isEmpty() && httpProxyPort > 0) {
                ...
                config.setProxy(httpProxyHost, httpProxyPort);
            }
