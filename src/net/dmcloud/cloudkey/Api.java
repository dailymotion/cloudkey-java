...
public class Api {
    ...
    public Api(String _user_id, String _api_key) {
        this(_user_id, _api_key, CloudKey.API_URL, CloudKey.CDN_URL, null, -1);
    }

    public Api(String _user_id, String _api_key, String _base_url, String _cdn_url, String _httpProxyHost, int _httpProxyPort) {
        this.user_id = _user_id;
        this.api_key = _api_key;
        this.base_url = _base_url;
        this.cdn_url = _cdn_url;
        this.httpProxyHost = _httpProxyHost;
        this.httpProxyPort = _httpProxyPort;
    }
    ...
    public DCObject call(String call, DCObject args) throws DCException {
        ...
        String response = Helpers.curl(this.base_url + "/api", json_encoded, httpProxyHost, httpProxyPort);
        try {
